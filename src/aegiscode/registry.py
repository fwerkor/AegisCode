...
class ToolRegistry:
    def __init__(self) -> None:
        ...
        rows = [
            ...
            ("browser_screenshot", True, False, "Create a screenshot artifact when Playwright is available", ["url", "output"], "browser"),
            ("browser_pdf", True, False, "Create a PDF artifact when Playwright is available", ["url", "output"], "browser"),
            ...
            ("test", True, False, "Run a validator command and capture output", ["command", "timeout"], "runtime"),
